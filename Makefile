...
helloworld32: helloworld.c my_i386.x
	gcc helloworld.c -m32 -o helloworld32 -Xlinker -T ./my_i386.x -Wl,-E,-q 


helloworldarm: helloworld.c my_arm.x
	../arm-2009q1/bin/arm-none-linux-gnueabi-gcc helloworld.c -o helloworldarm -Xlinker -T ./my_arm.x -Wl,-E,-q
